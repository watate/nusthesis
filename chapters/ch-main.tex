...
While it is possible to pass $\alpha$ directly, it's often easier to think about the span of an EW moment. In this work, unless otherwise specified, we use a span of 1000 for our smoothed results. This is also known as an "N-day EW moving average". That is:
\begin{equation}
...
\begin{figure}[h]
  ...
  \vspace{\BeforeCaptionVSpace}
  \caption{Graph of Performance vs Time (Smooth).}
...
In this section, we compare the performance of the 3 models. Worlde measure performance as the return of a trajectory (which is a measure of cumulative reward along the trajectory). The way this is computed is according to ~\autoref{main:eq:performance}:
...
\begin{figure}[h]
  ...
  \includegraphics[width=.9\linewidth]{\Pic{png}{paper_Simple World_Performance_Smooth_line}}
  \vspace{\BeforeCaptionVSpace}
  \caption{Performance vs Time (Simple World)}
  \label{main:performance_1}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=.9\linewidth]{\Pic{png}{paper_Complex World_Performance_Smooth_line}}
  \vspace{\BeforeCaptionVSpace}
  \caption{Performance vs Time (Simple World)}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.9\linewidth]{\Pic{png}{paper_Simple World_Success Rate_Smooth_line}}
  \vspace{\BeforeCaptionVSpace}
  \caption{Success Rate vs Time (Simple World)}
  \label{main:performance_3}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=.9\linewidth]{\Pic{png}{paper_Complex World_Success Rate_Smooth_line}}
  \vspace{\BeforeCaptionVSpace}
  \caption{Success Rate vs Time (Simple World)}
...
\begin{figure}[h]
  ...
  \vspace{\BeforeCaptionVSpace}
  \caption{Histogram of the linear jerk of all 3 models in Simple World~\autoref{appsec:simple_world}}
  \label{main:motion_1}
\end{figure}
...
\begin{figure}[h]
  ...
  \vspace{\BeforeCaptionVSpace}
  \caption{Histogram of the angular jerk of all 3 models in Simple World~\autoref{appsec:simple_world}}
  \label{main:motion_1}
\end{figure}
...
\begin{figure}[h]
  ...
  \vspace{\BeforeCaptionVSpace}
  \caption{Histogram of the linear jerk of all 3 models in Complex World~\autoref{appsec:complex_world}}
  \label{main:motion_1}
\end{figure}
...
\begin{figure}[h]
  ...
  \vspace{\BeforeCaptionVSpace}
  \caption{Histogram of the angular jerk of all 3 models in Complex World~\autoref{appsec:complex_world}}
  \label{main:motion_1}
\end{figure}
